...
#          0.0       0.94      0.97      0.95  18313512
#          1.0       0.85      0.71      0.78   4186488

#     accuracy                           0.92  22500000
#    macro avg       0.89      0.84      0.87  22500000
# weighted avg       0.92      0.92      0.92  22500000
...
def get_prediction_masks(patch_predictions):
    ...
    for k in range(num_images):
        ...
        cv2.imwrite('building_predictions/%d_before_threshold.jpg'%(k+1), img_as_ubyte(prediction))
        prediction[prediction > 0.5] = 1.
        prediction[prediction <= 0.5] = 0.
        cv2.imwrite('building_predictions/%d.jpg'%(k+1), img_as_ubyte(prediction))
...
test_data_dir = '../building_data/test/'
